<VAR $statType = "conf">
<QUERY name=TeamSeasonStats_baseball ID=$Home_TeamID SPORTNAME=$sqlSportName CATEGORY=$statType>
...
<VAR $statType = "conf">
<QUERY name=TeamSeasonStats_baseball ID=$Away_TeamID SPORTNAME=$sqlSportName CATEGORY=$statType>
...
<ELSE>
{$Away_TeamName} {$Away_Runs}, {$Home_TeamName} {$Home_Runs}
</IFGREATER>
...
<table class="boxscoreStatTable" WIDTH=350 CELLPADDING=0 CELLSPACING = 0>
<tr><td colspan="50"><b>Offense</b></td></tr>
<tr>
...
<table class="boxscoreStatTable" WIDTH=350 CELLPADDING=0 CELLSPACING=0>
<tr><td colspan="50"><b>Pitching</b></td></tr>
<tr>
<td width="120"><b>Name</td>
