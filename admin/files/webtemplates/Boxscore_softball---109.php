...
?>
<a href="{$domainURL}/players/{$player_slug}/{$Offense_PlayerID}/">
{$playerName}
</a>
</td>
...
$player_slug = slugify($playerName);
?>
<a href="{$domainURL}/players/{$player_slug}/{$Pitching_PlayerID}/">
{$playerName}
</a>
...
$player_slug = slugify($playerName);
?>
<a href="{$domainURL}/players/{$player_slug}/{$Fielding_PlayerID}/">
{$playerName}
</a>
</td>
