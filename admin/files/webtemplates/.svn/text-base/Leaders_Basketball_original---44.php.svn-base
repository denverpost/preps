...
<td align="right"><a href="{$beginLink}FieldGoalsAttempted" onmouseover="highlightKey('keyFieldGoalsAttempted')" onmouseout = "unHighlightKey('keyFieldGoalsAttempted')">FGA</a></td>
<td align="right"><a href="{$beginLink}FieldGoalPercentage" onmouseover="highlightKey('keyFieldGoalPercentage')" onmouseout = "unHighlightKey('keyFieldGoalPercentage')">FGPCT</a></td>
...
<td align="right"><a href="{$beginLink}ThreePointersAttempted" onmouseover="highlightKey('keyThreePointersAttempted')" onmouseout = "unHighlightKey('keyThreePointersAttempted')">3PA</a></td>
<td align="right"><a href="{$beginLink}ThreePointerPercentage" onmouseover="highlightKey('keyThreePointerPercentage')" onmouseout = "unHighlightKey('keyThreePointerPercentage')">3PPCT</a></td>
...
<td align="right"><a href="{$beginLink}OffensiveRebounds" onmouseover="highlightKey('keyOffensiveRebounds')" onmouseout = "unHighlightKey('keyOffensiveRebounds')">OREB</a></td>
<td align="right"><a href="{$beginLink}DefensiveRebounds" onmouseover="highlightKey('keyDefensiveRebounds')" onmouseout = "unHighlightKey('keyDefensiveRebounds')">DREB</a></td>
<td align="right"><a href="{$beginLink}Assists" onmouseover="highlightKey('keyAssists')" onmouseout = "unHighlightKey('keyAssists')">AST</a></td>
<td align="right"><a href="{$beginLink}Steals" onmouseover="highlightKey('keySteals')" onmouseout = "unHighlightKey('keySteals')">STL</a></td>
<td align="right"><a href="{$beginLink}BlockedShots" onmouseover="highlightKey('keyBlockedShots')" onmouseout = "unHighlightKey('keyBlockedShots')">BLK</a></td>
<td align="right"><a href="{$beginLink}Turnovers" onmouseover="highlightKey('keyTurnovers')" onmouseout = "unHighlightKey('keyTurnovers')">TO</a></td>
<td align="right"><a href="{$beginLink}PersonalFouls" onmouseover="highlightKey('keyPersonalFouls')" onmouseout = "unHighlightKey('keyPersonalFouls')">PF</a></td>
</tr>
...
<ROW NAME=LeaderBBallCol STATFIELD="FieldGoalsMade" STAT=$Leader_FieldGoalsMade>
<ROW NAME=LeaderBBallCol STATFIELD="FieldGoalsAttempted" STAT=$Leader_FieldGoalsAttempted>
<VAR $fgpct = round($Leader_FieldGoalPercentage,2)>
<ROW NAME=LeaderBBallCol STATFIELD="FieldGoalPercentage" STAT=$fgpct>
<ROW NAME=LeaderBBallCol STATFIELD="ThreePointersMade" STAT=$Leader_ThreePointersMade>
<ROW NAME=LeaderBBallCol STATFIELD="ThreePointersAttempted" STAT=$Leader_ThreePointersAttempted>
<VAR $tppct = round($Leader_ThreePointerPercentage,2)>
...
<VAR $ftpct = round($Leader_FreeThrowPercentage,2)>
