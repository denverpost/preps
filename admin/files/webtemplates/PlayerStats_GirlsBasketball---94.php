<table class="playerStatTable" cellpadding="0" cellspacing="0">
<tr><td colspan="75"><font class="pageTitle">Season Stats</font>
...
<td id="keyMinutes">Min: Minutes played</td>
</tr>
</table>
</div>
</td></tr>
<tr class="resultsText">
<!-- <td onmouseover="highlightKey('keyMinutes')" onmouseout = "unHighlightKey('keyMinutes')">Min</td> -->
<td onmouseover="highlightKey('keyPoints')" onmouseout = "unHighlightKey('keyPoints')">Pts</td>
<td onmouseover="highlightKey('keyFieldGoalsMade')" onmouseout = "unHighlightKey('keyFieldGoalsMade')">FGMd</td>
<td onmouseover="highlightKey('keyFieldGoalsAttempted')" onmouseout = "unHighlightKey('keyFieldGoalsAttempted')">FGAtt</td>
<td onmouseover="highlightKey('keyFieldGoalPercentage')" onmouseout = "unHighlightKey('keyFieldGoalPercentage')">FG%</td>
<td onmouseover="highlightKey('keyThreePointersMade')" onmouseout = "unHighlightKey('keyThreePointersMade')">3PtMd</td>
<td onmouseover="highlightKey('keyThreePointersAttempted')" onmouseout = "unHighlightKey('keyThreePointersAttempted')">3PtAtt</td>
<td onmouseover="highlightKey('keyThreePointerPercentage')" onmouseout = "unHighlightKey('keyThreePointerPercentage')">3Pt%</td>
<td onmouseover="highlightKey('keyFreeThrowsMade')" onmouseout = "unHighlightKey('keyFreeThrowsMade')">FTM</td>
<td onmouseover="highlightKey('keyFreeThrowsAttempted')" onmouseout = "unHighlightKey('keyFreeThrowsAttempted')">FTAtt</td>
<td onmouseover="highlightKey('keyFreeThrowPercentage')" onmouseout = "unHighlightKey('keyFreeThrowPercentage')">FT%</td>
...
<td onmouseover="highlightKey('keyBlockedShots')" onmouseout = "unHighlightKey('keyBlockedShots')">BLK</td>
...
<tr class="resultsText">
<!-- <td align="right">{$PlayerSeasonStats_Minutes}</td> -->
<td align="right">{$PlayerSeasonStats_Points}</td>
<td align="right">{$PlayerSeasonStats_FieldGoalsMade}</td>
<td align="right">{$PlayerSeasonStats_FieldGoalsAttempted}</td>
<VAR $fgpct = round($PlayerSeasonStats_FieldGoalPercentage,2)>
<td align="right">{$fgpct}</td>
<td align="right">{$PlayerSeasonStats_ThreePointersMade}</td>
<td align="right">{$PlayerSeasonStats_ThreePointersAttempted}</td>
<VAR $tppct = round($PlayerSeasonStats_ThreePointerPercentage,2)>
<td align="right">{$tppct}</td>
<td align="right">{$PlayerSeasonStats_FreeThrowsMade}</td>
<td align="right">{$PlayerSeasonStats_FreeThrowsAttempted}</td>
<VAR $ftpct = round($PlayerSeasonStats_FreeThrowPercentage,2)>
<td align="right">{$ftpct}</td>
<!-- <td align="right">{$PlayerSeasonStats_OffensiveRebounds}</td> 
<td align="right">{$PlayerSeasonStats_DefensiveRebounds}</td> 
 <td align="right">{$PlayerSeasonStats_Assists}</td> 
 <td align="right">{$PlayerSeasonStats_Steals}</td> 
 <td align="right">{$PlayerSeasonStats_BlockedShots}</td> 
 <td align="right">{$PlayerSeasonStats_Turnovers}</td>
-->  <td align="right">
{$PlayerSeasonStats_PersonalFouls}</td> 
</tr>
</table>