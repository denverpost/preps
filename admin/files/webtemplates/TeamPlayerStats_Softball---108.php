...
<QUERY name=TeamPlayerStats_Softball SPORTNAME=$sqlSportName SORT=$sortClause WHERECLAUSE=$whereClause TEAMID=$form_TeamID>
<h4>Offense</h4>
...
<IFGREATER count($TeamPlayerStats_Softball_rows) 0>
<VAR $rowClass="leadersRow trRow">
<RESULTS list=TeamPlayerStats_Softball_rows prefix=Offense>
        <tr class="{$rowClass}">
            <td>
...
<IFGREATER count($TeamPlayerStats_Softball_rows) 0>
<VAR $rowClass = "leadersRow trRow">
<RESULTS list=TeamPlayerStats_Softball_rows prefix=Pitching>
        <tr class="{$rowClass}">
            <td>
